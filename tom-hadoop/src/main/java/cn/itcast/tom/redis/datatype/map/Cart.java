 ...
 * 
 * <p>Titile:Cart</p>
 * <p>Description: 模拟商品购物车,需要有两个对象,一个商品对象,一个购物车对象</p>
 * @author TOM
 * @date 2017年6月22日 下午3:46:46
 */
public class Cart {
	private Jedis jedis;
	...
	public void updateProductCart(String userName, String productId, int num) {
		jedis.hincrBy("shop:cart" + userName, productId, num);
	}
	/**
	 * 
	 * @MethodName:getProductsByUserName
	 * @Description:购物车对象,shop:cart:usernName,某个人的购物车,是一个map类型的Redis,获取购物车中的商品信息
	 * @param userName
	 * @return
	 * @Time: 2017年6月22日 下午3:47:24
	 * @author: TOM
	 */
	public List<Product> getProductsByUserName(String userName) {
		...
		for (String key : productMap.keySet()) {
			...
			product.setId(key);// 获取购物车中商品编号
			int num = Integer.parseInt(productMap.get(key));
	...
	public static void main(String[] args) {
		...
		// 往用户购物车中添加商品
		cart.updateProductCart(userName, "1645080454", 10);
		cart.updateProductCart(userName, "1788744384", 1000);
		cart.updateProductCart(userName, "1645139266", -1000);
		// 打印当前用户的购物车信息
	 ...
	 * 
	 * @MethodName:initData
	 * @Description:商品对象,是一个String类型的k-v对,一个商品一个信息,使用(shop:product:商品Id,商品信息)
	 * @Time: 2017年6月22日 下午3:48:21
	 * @author: TOM
	 */
